...
define([
    ...
    var Petri = function  (options) {
        ...
        for (var i=0; i<this.sporesAt.length; i++){
            ...
            var cell = new Cell({
                tone         : this.getSound( parseInt(Math.random(1)*10) ),
                geometry     : geometry,
                material     : material,
...
/*        var play = function play () {
    ...
    Petri.prototype.getSound = function (i) {
        return new Audio( this.samplesDir + (i+1) + ".wav");
    }
